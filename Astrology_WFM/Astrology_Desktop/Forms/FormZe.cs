        ...
        public FormZe()
        {
            ...
            switch (dataZodiak.Month, dataZodiak.Day)
            {
                ...
                case (6, >= 22) or (7, <= 22):
                    ...
                    labelZodiac.Text = "Rak to znak zodiaku, który jest symbolem emocjonalnej głębi i intuicji, często ukrywający swoją wrażliwość pod zewnętrzną twardością.\r\n\n" +
                        ...
                        "    Księżyc, jako władca Raka, nadaje mu tajemniczość i wpływa na zmienne nastroje, które mogą być równie zmiennych jak fazy księżycowe.\r\n\n" +
                        "    Rak ceni sobie dom i rodzinę ponad wszystko, tworząc wokół siebie atmosferę bezpieczeństwa i komfortu.\r\n\n" +
                ...
                case (7, >= 23) or (8, <= 22):
                    ...
                    labelZodiac.Text = "Lew jest znakiem zodiaku, który emanuje naturalnymi zdolnościami przywódczymi i pewnością siebie, co czyni go magnetycznym i charyzmatycznym liderem.\r\n\n" +
                        "    Osoby spod tego znaku są często hojne i lojalne, mając wielu przyjaciół dzięki swojej serdeczności i zdrowemu poczuciu humoru.\r\n\n" +
                        "    Słońce, jako planeta rządząca Lwem, nadaje mu siłę i blask, inspirując do dążenia do samoświadomości i rozwoju osobistego.\r\n\n" +
                        "    Lwy cenią sobie zabawę i luksus, a ich żywioł ognia sprawia, że są pełne pasji i entuzjazmu do życia.\r\n\n" +
                ...
                case (8, >= 23) or (9, <= 22):
                    ...
                    labelZodiac.Text = "Panna to znak zodiaku, który jest uosobieniem dokładności i skrupulatności, z silnym zmysłem analitycznym i praktycznym podejściem do życia.\r\n\n" +
                        "    Osoby urodzone pod tym znakiem często cechuje perfekcjonizm i tendencja do analizowania każdego szczegółu, co sprawia, że są niezawodne w każdym zadaniu.\r\n\n" +
                        "    Rządząca Panną planeta Merkury wpływa na ich komunikatywność i inteligencję, co czyni je świetnymi rozwiązywaczami problemów.\r\n\n" +
                ...
                case (9, >= 23) or (10, <= 23):
                    ...
                    labelZodiac.Text = "Waga to znak zodiaku, który symbolizuje równowagę i harmonię, a osoby urodzone pod tym znakiem są bardzo empatyczne i dążą do unikania konfliktów.\r\n\n" +
                        "    Rządzone przez planetę Wenus, Wagi mają naturalną skłonność do doceniania piękna i sztuki, często wykazując zainteresowanie kulturą i uczestnicząc w wydarzeniach artystycznych.\r\n\n" +
                        "    Wagi są znane z ich dyplomatycznego podejścia do życia, mają tendencję do bycia sprawiedliwymi i uczciwymi, co czyni je doskonałymi mediatorami w każdej sytuacji.\r\n\n" +
                        "    Charakteryzują się one również urokiem osobistym i życzliwością, co sprawia, że są dobrze odbierane przez otoczenie i mają wielu przyjaciół.\r\n\n" +
                        "    Mimo że czasami mogą być niezdecydowane, Wagi są lojalne i prawdomówne, a ich silna osobowość pomaga im w rozwiązywaniu problemów i podejmowaniu ważnych decyzji.\r\n";
                    labelTitle.Text = "Waga (23 września - 22 października): Symbolizuje równowagę i harmonię.";
                    break;
                case (10, >= 24) or (11, <= 22):
                    zodiacPicture.Image = zodiac.scorpio;
                    labelZodiac.Text = "Skorpion to znak zodiaku, który jest znany z intensywnej energii i emocji, rządzą nim silne planety jak Mars i Pluton, co nadaje mu cechy transformacji i odrodzenia.\r\n\n" +
                        "    Osoby urodzone pod tym znakiem są często postrzegane jako detektywi, poznają tajemnice i odkrywają ukryte prawdy.\r\n\n" +
                        "    Charakterystyczne dla Skorpiona jest jego wytrwałość i ambicja, a także głęboka emocjonalność i wysoka intuicja, co sprawia, że są oni pasjonatami swoich zainteresowań i relacji.\r\n\n" +
                        "    Skorpiony cenią głębokie rozmowy i związki emocjonalne, unikając powierzchowności i płytkich relacji.\r\n\n" +
                        "    Mimo że mogą być postrzegane jako osoby o silnym charakterze i nieustraszone, w rzeczywistości Skorpiony są lojalne i namiętne, gotowe do wielkich poświęceń dla bliskich.\r\n ";
                ...
                case (11, >= 23) or (12, <= 21):
                    ...
                    labelZodiac.Text = "Strzelce są znane ze swojego optymizmu i miłości do wolności, co często prowadzi ich do poszukiwania nowych przygód i doświadczeń.\r\n\n" +
                ...
                case (12, >= 22) or (1, <= 19):
                    ...
                    labelZodiac.Text = "Koziorożce są ambitne i dyscyplinowane, co sprawia, że często osiągają sukcesy dzięki swojej ciężkiej pracy i praktycznemu podejściu do życia.\r\n\n" +
                ...
                case (2, >= 19) or (3, <= 20):
                    ...
                    labelZodiac.Text = "Ryby są intuicyjne i empatyczne, co pozwala im głęboko rozumieć uczucia innych i często sprawia, że angażują się w działania pomocowe.\r\n\n" +
                        ...
                        "    Rządząca planetą Ryb jest Neptun, co wiąże się z ich marzycielską naturą i skłonnością do ucieczki w świat fantazji i snów.\r\n\n" +
                        "    Ryby są znane z ich wrażliwości i bezinteresowności, często stawiając potrzeby innych ponad własne, co może prowadzić do nadmiernego poświęcenia.\r\n\n" +
                        "    W relacjach międzyludzkich Ryby szukają duchowego porozumienia i głębokiej więzi, pragnąc miłości, która jest równie bajkowa, jak ich idealistyczne wyobrażenia o związku.\r\n";
